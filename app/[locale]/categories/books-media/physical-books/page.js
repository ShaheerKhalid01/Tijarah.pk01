...
// Mock data for physical books products
export const physicalbooksProducts = [
  {
...
// Price ranges in PKR
const priceRanges = [
  { id: '0-1500', name: 'Under PKR 1,500', value: '0-1500' },
  { id: '1500-2000', name: 'PKR 1,500 - 2,000', value: '1500-2000' },
  { id: '2000-2500', name: 'PKR 2,000 - 2,500', value: '2000-2500' },
  { id: '2500', name: 'Over PKR 2,500', value: '2500' },
];

export default function PhysicalBooksCategory() {
  ...
  const filteredProducts = physicalbooksProducts.filter(product => {
    // Filter by author
    ...
    <div className="bg-white">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-blue-800 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl font-extrabold tracking-tight">Physical Books</h1>
          <p className="mt-4 text-xl text-blue-100">
            Explore our collection of quality books
          </p>
        </div>
      </div>
                ...
                <div className="space-y-2">
                  {categories.map((category) => (
                    <div key={category.id} className="flex items-center justify-between">
                      <Link 
                        href={`/${locale}/categories/physical-books/${category.id}`}
          ...
          <div className="flex-1">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
              <p className="text-sm text-gray-500 mb-4 sm:mb-0">
                Showing {indexOfFirstProduct + 1}-{Math.min(indexOfLastProduct, filteredProducts.length)} of {filteredProducts.length} books
              </p>
