...
// Mock data for organic products from your file
export const organicProducts = [
  {
    id: 1,
    name: 'Organic Quinoa - High Protein Grains & Cereals (500g)',
    price: 599,
    image: 'https://images.unsplash.com/photo-1541013406132-d1f8a3f6a2e9?ixlib=rb-4.0.3&w=400&h=500&fit=crop&q=80',
    rating: 4.8,
    brand: 'TruVibe',
    inStock: true
  },
  {
    id: 2,
    name: 'Organic Honey - Pure Raw Sweetener (500g)',
    price: 899,
    image: 'https://images.unsplash.com/photo-1551504736-2a4d5d0c9c9a?ixlib=rb-4.0.3&w=400&h=500&fit=crop&q=80',
    rating: 4.9,
    brand: 'NatureNest',
    inStock: true
  },
  {
    id: 3,
    name: 'Organic Coconut Oil - Cold Pressed Virgin Oil (500ml)',
    price: 1299,
    image: 'https://images.unsplash.com/photo-1600562304198-8d2bb7d1a1d0?ixlib=rb-4.0.3&w=400&h=500&fit=crop&q=80',
    rating: 4.7,
    brand: 'CocoVeda',
    inStock: true
  },
  {
    id: 4,
    name: 'Organic Almonds - Raw Nuts & Seeds (500g)',
    price: 1499,
    image: 'https://images.unsplash.com/photo-1585589266882-2cb137ba7db6?ixlib=rb-4.0.3&w=400&h=500&fit=crop&q=80',
    rating: 4.8,
  ...
  {
    id: 5,
    name: 'Organic Green Tea - Premium Tea & Coffee Leaves',
    price: 699,
  ...
  {
    id: 6,
    name: 'Organic Chia Seeds - Nutrient Rich Superfood (250g)',
    price: 899,
    image: 'https://images.unsplash.com/photo-1597328290889-8e0c2f5d6c5f?ixlib=rb-4.0.3&w=400&h=500&fit=crop&q=80',
    rating: 4.8,
    brand: 'HealthVeda',
    inStock: true
  }
...
// Subcategories
const subcategories = [
  { id: 'grains', name: 'Grains & Cereals', count: 12 },
  { id: 'sweeteners', name: 'Sweeteners', count: 8 },
  { id: 'oils', name: 'Oils & Vinegars', count: 15 },
  { id: 'nuts', name: 'Nuts & Seeds', count: 20 },
  { id: 'tea', name: 'Tea & Coffee', count: 10 },
];

// Brands
const brands = [
  { id: 'truvibe', name: 'TruVibe', count: 5 },
  { id: 'cocoveda', name: 'CocoVeda', count: 12 },
  { id: 'naturenest', name: 'NatureNest', count: 4 },
  { id: 'organic-harvest', name: 'Organic Harvest', count: 8 },
];
...
const priceRanges = [
  ...
  { id: '1000-1500', name: 'PKR 1000 - 1500', value: '1000-1500' },
  { id: '1500', name: 'Over PKR 1500', value: '1500' },
];

export default function OrganicCategory() {
    ...
    <div className="bg-white">
      ...
      <div className="bg-gradient-to-r from-green-600 to-emerald-800 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl font-extrabold tracking-tight">Organic Products</h1>
          <p className="mt-4 text-xl text-green-100">
            Healthy, chemical-free organic foods for a better lifestyle
          </p>
        </div>
      </div>
                ...
                <div className="space-y-2">
                  {subcategories.map((category) => (
                    <div key={category.id} className="flex items-center justify-between">
                      <Link href={`/${locale}/categories/organic/${category.id}`} className="text-gray-600 hover:text-green-600 text-sm">
                        {category.name}
                      </Link>
