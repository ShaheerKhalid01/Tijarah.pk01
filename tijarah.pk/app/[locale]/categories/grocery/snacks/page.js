...
// Mock data for snacks from your file
export const snacksProducts = [
  {
    id: 1,
    name: 'Lays Crispy Potato Chips - Classic Salt & Vinegar Flavor',
    price: 149,
  ...
  {
    id: 2,
    name: 'Britannia Chocolate Chip Cookies - Rich Cocoa Flavor',
    price: 129,
    image: 'https://images.unsplash.com/photo-1585080504055-bf838c5446e0?ixlib=rb-4.0.3&w=400&h=500&fit=crop&q=80',
    rating: 4.9,
    brand: 'Britannia',
    inStock: true
  },
  {
    id: 3,
    name: 'Happilo Roasted Almonds Mix - Premium Healthy Nuts',
    price: 199,
    image: 'https://images.unsplash.com/photo-1585707032515-6595650c67c0?ixlib=rb-4.0.3&w=400&h=500&fit=crop&q=80',
    rating: 4.7,
    brand: 'Happilo',
    inStock: true
  },
  {
    id: 4,
    name: 'ITC Spicy Corn Snacks - Tangy Puffed & Fried',
    price: 119,
    image: 'https://images.unsplash.com/photo-1599599810694-b5ac4dd64999?ixlib=rb-4.0.3&w=400&h=500&fit=crop&q=80',
    rating: 4.6,
    brand: 'ITC',
    inStock: true
  },
  {
    id: 5,
    name: 'Urban Platter Fruit & Nut Bar - Mixed Berries Energy',
    price: 159,
    image: 'https://images.unsplash.com/photo-1599599810694-b5ac4dd64999?ixlib=rb-4.0.3&w=400&h=500&fit=crop&q=80',
    rating: 4.8,
    brand: 'Urban Platter',
  ...
  {
    id: 6,
    name: 'Sunfeast Cheese Flavored Crackers - Savory Crispy Bite',
    price: 139,
    image: 'https://images.unsplash.com/photo-1585707032515-6595650c67c0?ixlib=rb-4.0.3&w=400&h=500&fit=crop&q=80',
    rating: 4.7,
    brand: 'Sunfeast',
...
// Filters
const subcategories = [
  { id: 'chips', name: 'Chips & Crisps', count: 25 },
  { id: 'cookies', name: 'Cookies & Biscuits', count: 30 },
  { id: 'nuts', name: 'Nuts & Seeds', count: 15 },
  { id: 'chocolate', name: 'Chocolate & Confectionery', count: 40 },
];

const brands = [
  { id: 'lays', name: 'Lays', count: 10 },
  { id: 'britannia', name: 'Britannia', count: 8 },
  { id: 'happilo', name: 'Happilo', count: 12 },
  { id: 'cadbury', name: 'Cadbury', count: 15 },
];

const priceRanges = [
  { id: '0-150', name: 'Under PKR 150', value: '0-150' },
  { id: '150-200', name: 'PKR 150 - 200', value: '150-200' },
  { id: '200-250', name: 'PKR 200 - 250', value: '200-250' },
  { id: '250', name: 'Over PKR 250', value: '250' },
];

export default function SnacksCategory() {
  ...
  // Filter Logic
  const filteredProducts = snacksProducts.filter(product => {
  ...
  return (
    <div className="bg-white">
      ...
      <div className="bg-gradient-to-r from-orange-600 to-red-800 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl font-extrabold tracking-tight">Snacks</h1>
          <p className="mt-4 text-xl text-orange-100">
            Delicious snacks for every craving and occasion
          </p>
        </div>
      </div>
                ...
                <div className="space-y-2">
                  {subcategories.map((category) => (
                    <div key={category.id} className="flex items-center justify-between">
                      <Link href={`/${locale}/categories/snacks/${category.id}`} className="text-gray-600 hover:text-orange-600 text-sm">
                        {category.name}
                      </Link>
          ...
          <div className="flex-1">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
              ...
              <div className="flex items-center">
                ...
                <select
                  id="sort"
                  className="pl-3 pr-10 py-2 border-gray-300 focus:ring-orange-500 rounded-md sm:text-sm"
                  value={sortBy}
                  ...
                  {Array.from({ length: totalPages }, (_, i) => i + 1).map((number) => (
                    <li key={number}>
                      <button
                        ...
                        className={`px-3 py-2 border ${currentPage === number ? 'z-10 text-orange-600 bg-orange-50 border-orange-300' : 'text-gray-500 bg-white border-gray-300 hover:bg-gray-100'}`}
                      >
                        {number}
                      </button>
                    </li>
