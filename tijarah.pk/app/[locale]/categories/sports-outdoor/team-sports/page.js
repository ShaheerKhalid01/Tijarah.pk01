...
// Mock data for team sports products
export const teamSportsProducts = [
  {
    id: 'soccer-1',
    name: 'Adidas Soccer Ball - Size 5 Professional Match Ball',
    price: 3499,
    image: 'https://images.unsplash.com/photo-1574629810360-7efbbe195018?w=600&auto=format&fit=crop&q=60',
    rating: 4.7,
    brand: 'Adidas',
    inStock: true
  },
  {
    id: 'basketball-1',
    name: 'Spalding Official NBA Size 7',
    price: 4299,
  ...
  {
    id: 'volleyball-1',
    name: 'Wilson Volleyball Set with Regulation Net and Poles',
    price: 12999,
    image: 'https://images.unsplash.com/photo-1612872086822-67cccc167624?w=600&auto=format&fit=crop&q=60',
    rating: 4.5,
    brand: 'Wilson',
    inStock: true
  },
  ...
  {
    id: 'hockey-1',
    name: 'Grays Field Hockey Stick - Carbon Fiber Professional Edition',
    price: 8999,
    image: 'https://images.unsplash.com/photo-1580748141549-71748ddf0bdc?w=600&auto=format&fit=crop&q=60',
    rating: 4.6,
    brand: 'Grays',
    inStock: true
  },
  {
    id: 'baseball-1',
    name: 'Rawlings Leather Baseball Glove',
    price: 7499,
    image: 'https://images.unsplash.com/photo-1516731415730-0c607149933a?w=600&auto=format&fit=crop&q=60',
    rating: 4.7,
    brand: 'Rawlings',
    inStock: true
  }
...
// Subcategories
const subcategories = [
  { id: 'soccer', name: 'Soccer', count: 24 },
  { id: 'basketball', name: 'Basketball', count: 18 },
  { id: 'cricket', name: 'Cricket', count: 32 },
  { id: 'volleyball', name: 'Volleyball', count: 15 },
  { id: 'hockey', name: 'Hockey', count: 12 },
  { id: 'baseball', name: 'Baseball', count: 10 },
];

// Brands filter
const brands = [
  { id: 'adidas', name: 'Adidas', count: 20 },
  { id: 'wilson', name: 'Wilson', count: 15 },
  { id: 'spalding', name: 'Spalding', count: 12 },
  { id: 'kookaburra', name: 'Kookaburra', count: 8 },
  { id: 'grays', name: 'Grays', count: 7 },
];
...
export default function TeamSportsCategory() {
  ...
  // Filter Logic
  const filteredProducts = teamSportsProducts.filter(product => {
  ...
  return (
    <div className="bg-white">
      {/* Hero Section */}
      <div className="bg-gradient-to-r from-blue-700 to-cyan-600 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl font-extrabold tracking-tight">Team Sports</h1>
          <p className="mt-4 text-xl text-blue-100">
            Professional grade equipment for your favorite team games
          </p>
        </div>
      </div>
                ...
                <div className="space-y-2">
                  {subcategories.map((category) => (
                    <div key={category.id} className="flex items-center justify-between">
                      <Link href={`/${locale}/categories/team-sports/${category.id}`} className="text-gray-600 hover:text-blue-600 text-sm">
                        {category.name}
                      </Link>
          ...
          <div className="flex-1">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
              ...
              <div className="flex items-center">
                ...
                <select
                  id="sort"
                  className="mt-1 block w-full pl-3 pr-10 py-2 border-gray-300 focus:outline-none focus:ring-blue-500 rounded-md sm:text-sm"
                  value={sortBy}
                  ...
                  <div className="p-4 flex flex-col flex-1">
                    <h3 className="text-sm font-medium text-gray-900 mb-2">
                      <Link href={`/${locale}/products/${product.id}`}>
                        {/* h-10 ensures alignment regardless of title text length */}
