...
// Mock data for outdoor products
export const outdoorProducts = [
  {
    id: 'tent-1',
    name: '4-Person Waterproof Camping Tent with Easy Setup Technology',
    price: 24999,
  ...
  {
    id: 'stove-1',
    name: 'Portable Camping Stove for High Altitude',
    price: 4500,
  ...
  {
    id: 'boots-1',
    name: 'Men\'s Waterproof Hiking Boots with All-Terrain Grip',
    price: 15500,
    image: 'https://images.unsplash.com/photo-1542272454315-4c01d7abdf4a?w=600&auto=format&fit=crop&q=60',
    rating: 4.9,
    brand: 'Timberland',
    inStock: true
  },
...
const subcategories = [
  { id: 'camping', name: 'Camping Gear', count: 42 },
  { id: 'hiking', name: 'Hiking & Trekking', count: 35 },
  { id: 'climbing', name: 'Climbing Gear', count: 18 },
  { id: 'navigation', name: 'Navigation & Tools', count: 12 },
  { id: 'lighting', name: 'Outdoor Lighting', count: 20 },
];

const brands = [
  { id: 'coleman', name: 'Coleman', count: 15 },
  { id: 'osprey', name: 'Osprey', count: 8 },
  { id: 'northface', name: 'The North Face', count: 12 },
  { id: 'timberland', name: 'Timberland', count: 10 },
  { id: 'blackdiamond', name: 'Black Diamond', count: 6 },
];
...
export default function OutdoorRecreationCategory() {
    ...
    <div className="bg-white">
      ...
      <div className="bg-gradient-to-r from-green-600 to-teal-800 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl font-extrabold tracking-tight">Outdoor Recreation</h1>
          <p className="mt-4 text-xl text-green-100">Premium gear for your next adventure in the wild</p>
        </div>
      </div>
                ...
                <div className="space-y-2">
                  {subcategories.map((category) => (
                    <div key={category.id} className="flex items-center justify-between">
                      <Link href={`/${locale}/categories/outdoor/${category.id}`} className="text-gray-600 hover:text-green-600 text-sm">
                        {category.name}
                      </Link>
