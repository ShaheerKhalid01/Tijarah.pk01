...
// Mock data for audiobooks products
export const audiobooksProducts = [
  {
    id: 'psychology-of-money',
    name: 'The Psychology of Money',
    price: 1999,
    image: 'https://images.unsplash.com/photo-1507843566290-e0fa34ff4d70?w=600&auto=format&fit=crop&q=60',
    rating: 4.7,
  ...
  },
  {
    ...
    price: 1799,
    image: 'https://images.unsplash.com/photo-1446776653964-20c1d3a81b06?w=600&auto=format&fit=crop&q=60',
    rating: 4.9,
  ...
  },
  {
    ...
    price: 1599,
    image: 'https://images.unsplash.com/photo-1453928582348-e0fa34ff4d51?w=600&auto=format&fit=crop&q=60',
    rating: 4.6,
  ...
  },
  {
    ...
    name: 'Sapiens',
    price: 1699,
    image: 'https://images.unsplash.com/photo-1518837695005-2083093ee35b?w=600&auto=format&fit=crop&q=60',
    rating: 4.6,
  ...
  },
  {
    ...
    price: 1899,
    image: 'https://images.unsplash.com/photo-1495446815901-a7297e633e8?w=600&auto=format&fit=crop&q=60',
    rating: 4.7,
...
const categories = [
  { id: 'personal-finance', name: 'Personal Finance', count: 24 },
  { id: 'self-help', name: 'Self-Help', count: 18 },
  { id: 'fiction', name: 'Fiction', count: 15 },
  { id: 'sci-fi', name: 'Science Fiction', count: 22 },
  { id: 'biography', name: 'Biography', count: 12 },
  { id: 'history', name: 'History', count: 16 },
  { id: 'mystery', name: 'Mystery', count: 20 },
  { id: 'psychology', name: 'Psychology', count: 14 }
];
...
const authors = [
  ...
  { id: 'stephen', name: 'Stephen R. Covey', count: 6 },
  { id: 'yuval', name: 'Yuval Noah Harari', count: 5 }
];
...
export default function AudiobooksCategory() {
  ...
  const filteredProducts = audiobooksProducts.filter(product => {
    // Filter by author
    ...
    <div className="bg-white">
      ...
      <div className="bg-gradient-to-r from-purple-600 to-blue-800 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl font-extrabold tracking-tight">Audiobooks</h1>
          <p className="mt-4 text-xl text-purple-100">
            Immerse yourself in thousands of titles
          </p>
        </div>
      </div>
                ...
                <div className="space-y-2">
                  {categories.map((category) => (
                    <div key={category.id} className="flex items-center justify-between">
                      <Link 
                        href={`/${locale}/categories/audiobooks/${category.id}`}
          ...
          <div className="flex-1">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
              <p className="text-sm text-gray-500 mb-4 sm:mb-0">
                Showing {indexOfFirstProduct + 1}-{Math.min(indexOfLastProduct, filteredProducts.length)} of {filteredProducts.length} audiobooks
              </p>
