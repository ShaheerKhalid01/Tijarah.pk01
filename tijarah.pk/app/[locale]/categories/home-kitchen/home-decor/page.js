...
// Mock data for home decor products
export const homeDecorProducts = [
  {
    id: 'modern-wall-art',
    name: 'Modern Wall Art Set of 3',
    price: 12999,
    image: 'https://images.unsplash.com/photo-1616486338815-671e077e25aa?w=600&auto=format&fit=crop&q=60',
    rating: 4.7,
    description: 'Contemporary wall art collection for modern homes',
    brand: 'UrbanLoft',
    inStock: true
  },
  {
    ...
    rating: 4.5,
    description: 'Elegant ceramic vase for any interior',
    brand: 'CeramiCraft',
    inStock: true
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1584917865442-de89df76afd3?w=600&auto=format&fit=crop&q=60',
    rating: 4.8,
    description: 'Premium linen pillow cover in neutral tones',
    brand: 'CozyHome',
    inStock: true
  },
  {
    ...
    price: 7999,
    image: 'https://images.unsplash.com/photo-1578926375602-e6f8c8de7c91?w=600&auto=format&fit=crop&q=60',
    rating: 4.6,
    description: 'Handcrafted rustic wooden wall clock',
    brand: 'RusticHaven',
    inStock: true
  },
  {
    ...
    price: 3999,
    image: 'https://images.unsplash.com/photo-1603398748027-6728edb01b9b?w=600&auto=format&fit=crop&q=60',
    rating: 4.9,
    description: 'Premium scented candles with natural wax',
    brand: 'AromaGlow',
    inStock: true
  },
  {
    id: 'geometric-bookends',
    name: 'Geometric Bookends',
    price: 3499,
    image: 'https://images.unsplash.com/photo-1602810319428-019690571b5b?w=600&auto=format&fit=crop&q=60',
    rating: 4.4,
    description: 'Modern geometric bookends for shelves',
    brand: 'ModaLiving',
    inStock: true
  },
  {
    ...
    price: 5499,
    image: 'https://images.unsplash.com/photo-1513519245088-0e12902b5be9?w=600&auto=format&fit=crop&q=60',
    rating: 4.7,
    description: 'Bohemian macrame wall hanging decoration',
    brand: 'BohemianChic',
    inStock: true
  },
  {
    ...
    rating: 4.5,
    description: 'Beautiful ceramic bowl for fruits and display',
    brand: 'CeramiCraft',
    inStock: true
  }
];
...
const subcategories = [
  { id: 'wall-art', name: 'Wall Art & Mirrors', count: 24 },
  { id: 'pillows', name: 'Decorative Pillows', count: 18 },
  { id: 'vases', name: 'Vases & Bowls', count: 15 },
  { id: 'candles', name: 'Candles & Holders', count: 22 },
  { id: 'clocks', name: 'Clocks', count: 12 },
  { id: 'accents', name: 'Decorative Accents', count: 28 },
  { id: 'frames', name: 'Photo Frames', count: 16 },
  { id: 'plants', name: 'Artificial Plants', count: 20 }
];

// Brands for filter
const brands = [
  { id: 'urbanloft', name: 'UrbanLoft', count: 10 },
  { id: 'ceramicraft', name: 'CeramiCraft', count: 8 },
  { id: 'cozyhome', name: 'CozyHome', count: 7 },
  { id: 'rustichaven', name: 'RusticHaven', count: 9 },
  { id: 'aromaglow', name: 'AromaGlow', count: 6 },
  { id: 'modaliving', name: 'ModaLiving', count: 5 }
];
...
export default function HomeDecorCategory() {
  ...
  const filteredProducts = homeDecorProducts.filter(product => {
    // Filter by brand
    ...
    <div className="bg-white">
      ...
      <div className="bg-gradient-to-r from-purple-600 to-pink-600 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl font-extrabold tracking-tight">Home Decor</h1>
          <p className="mt-4 text-xl text-purple-100">
            Beautiful decorations to transform your space
          </p>
        </div>
      </div>
                ...
                <div className="space-y-2">
                  {subcategories.map((category) => (
                    <div key={category.id} className="flex items-center justify-between">
                      <Link 
                        href={`/${locale}/categories/home-decor/${category.id}`}
