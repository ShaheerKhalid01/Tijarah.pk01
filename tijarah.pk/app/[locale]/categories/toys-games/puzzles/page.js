...
// Mock data for puzzles from your file
export const puzzlesProducts = [
  {
    id: 1,
    name: '1000 Piece Mountain Landscape Puzzle - High Detail Jigsaw',
    price: 1499,
    image: 'https://images.unsplash.com/photo-1605633239494-0fb4b4a254b8?ixlib=rb-4.0.3&w=400&h=500&fit=crop&q=80',
    rating: 4.9,
    brand: 'Ravensburger',
    inStock: true
  },
  {
    id: 2,
    name: '500 Piece Ocean Sunset Puzzle',
    price: 999,
    image: 'https://images.unsplash.com/photo-1577720643272-265f434e6f5f?ixlib=rb-4.0.3&w=400&h=500&fit=crop&q=80',
    rating: 4.8,
    brand: 'Cobble Hill',
    inStock: true
  },
  {
    id: 3,
    name: "Rubik's 3x3 Speed Cube - Smooth Mechanism 3D Puzzle",
    price: 699,
    image: 'https://images.unsplash.com/photo-1587654209683-3e31aae34cb7?ixlib=rb-4.0.3&w=400&h=500&fit=crop&q=80',
    rating: 4.7,
    brand: "Rubik's",
    inStock: true
  },
  {
    id: 4,
    name: '2000 Piece Historical Map Puzzle - Premium Edition',
    price: 2499,
    image: 'https://images.unsplash.com/photo-1594200494662-23bbf1ce3e21?ixlib=rb-4.0.3&w=400&h=500&fit=crop&q=80',
    rating: 4.6,
    brand: 'Eurographics',
    inStock: true
  },
  {
    id: 5,
    name: '300 Piece Animals in the Zoo Puzzle for Kids',
    price: 699,
    image: 'https://images.unsplash.com/photo-1605633239494-0fb4b4a254b8?ixlib=rb-4.0.3&w=400&h=500&fit=crop&q=80',
    rating: 4.8,
    brand: 'Castorland',
  ...
  {
    id: 6,
    name: 'Hanayama Metal Brain Teaser Puzzle - Level 6 Difficulty',
    price: 1299,
...
// Filter arrays
const subcategories = [
  { id: 'jigsaw', name: 'Jigsaw Puzzles', count: 45 },
  { id: '3d-puzzle', name: '3D Puzzles', count: 12 },
  { id: 'brain-teaser', name: 'Brain Teasers', count: 18 },
  { id: 'logic', name: 'Logic Puzzles', count: 10 },
];

const brands = [
  { id: 'ravensburger', name: 'Ravensburger', count: 15 },
  { id: 'rubiks', name: "Rubik's", count: 8 },
  { id: 'hanayama', name: 'Hanayama', count: 6 },
  { id: 'eurographics', name: 'Eurographics', count: 10 },
];

const priceRanges = [
  { id: '0-1000', name: 'Under PKR 1,000', value: '0-1000' },
  { id: '1000-1500', name: 'PKR 1,000 - 1,500', value: '1000-1500' },
  { id: '1500-2500', name: 'PKR 1,500 - 2,500', value: '1500-2500' },
  { id: '2500', name: 'Over PKR 2,500', value: '2500' },
];

export default function PuzzlesCategory() {
  ...
  // Filter Logic
  const filteredProducts = puzzlesProducts.filter(product => {
  ...
  return (
    <div className="bg-white">
      {/* Hero Section */}
      <div className="bg-gradient-to-r from-amber-600 to-orange-800 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl font-extrabold tracking-tight">Puzzles</h1>
          <p className="mt-4 text-xl text-amber-100">
            Discover brain-teasing puzzles for all ages and skill levels
          </p>
        </div>
      </div>
                ...
                <div className="space-y-2">
                  {subcategories.map((category) => (
                    <div key={category.id} className="flex items-center justify-between">
                      <Link href={`/${locale}/categories/puzzles/${category.id}`} className="text-gray-600 hover:text-amber-600 text-sm">
                        {category.name}
                      </Link>
          ...
          <div className="flex-1">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
              ...
              <div className="flex items-center">
                ...
                <select
                  id="sort"
                  className="pl-3 pr-10 py-2 border-gray-300 focus:ring-amber-500 rounded-md sm:text-sm"
                  value={sortBy}
                  ...
                  {Array.from({ length: totalPages }, (_, i) => i + 1).map((number) => (
                    <li key={number}>
                      <button
                        ...
                        className={`px-3 py-2 border ${currentPage === number ? 'z-10 text-amber-600 bg-amber-50 border-amber-300' : 'text-gray-500 bg-white border-gray-300 hover:bg-gray-100'}`}
                      >
                        {number}
                      </button>
                    </li>
