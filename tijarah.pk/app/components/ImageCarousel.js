...
const SlideContent = memo(({ slide, locale }) => {
  ...
  return (
    <>
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-black/60 to-black/30 z-10 flex items-center justify-center text-center px-4 sm:px-8 md:px-12 lg:px-16 xl:px-24">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-white text-4xl md:text-6xl lg:text-7xl font-bold mb-3 md:mb-6 leading-tight tracking-tight drop-shadow-xl font-[900]">
            {slide.title}
          </h2>
